...
class IRR_DiffSRGANModel(SRGANModel):
    """
    ...
    def __init__(self, opt):
        super(IRR_DiffSRGANModel, self).__init__(opt)
    ...
    def init_training_settings(self):
        ...
        if train_opt.get('kd_opt'):
            ...
            self.cri_kd = None
        super(IRR_DiffSRGANModel, self).init_training_settings()
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(IRR_DiffSRGANModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
    ...
    def optimize_parameters(self, current_iter):
        ...
        _, S1_IRR = self.model_Es1(self.lq,l1_gt)
        ...
        self.output, pred_IRR_list = self.net_g(self.lq,S1_IRR[0])
        ...
        if (current_iter % self.net_d_iters == 0 and current_iter > self.net_d_init_iters):
            ...
            if self.cri_kd:
                i=len(pred_IRR_list)-1
                S2_IRR=[pred_IRR_list[i]]
                l_kd, l_abs = self.cri_kd(S1_IRR, S2_IRR)
                l_g_total += l_abs+l_kd
