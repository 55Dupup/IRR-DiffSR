...
class IRR_DiffSRModel(SRModel):
    ...
    def __init__(self, opt):
        super(IRR_DiffSRModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(IRR_DiffSRModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
    ...
    def optimize_parameters(self, current_iter):
        ...
        _, S1_IRR = self.model_Es1(self.lq,self.gt)# list of IRR feature

        if current_iter < self.encoder_iter:
            self.optimizer_e.zero_grad()
            _, pred_IRR_list = self.net_g.module.diffusion(self.lq,S1_IRR[0])
