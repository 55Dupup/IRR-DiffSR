...
class IRR_EncoderModel(SRModel):
    """
    ...
    def __init__(self, opt):
        super(IRR_EncoderModel, self).__init__(opt)
    ...
    def feed_data(self, data):
        ...
        """
        if self.is_train and self.opt.get('high_order_degradation', True):#True
            # print('use RealESRGAN Degradation')
            ...
            # print('not use RealESRGAN Degradation')
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        #DiffIRS1Model
        super(IRR_EncoderModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
