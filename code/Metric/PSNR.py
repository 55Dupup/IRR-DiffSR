...
def main():
    ...
    parser.add_argument('--folder_restored', type=str, default='/data/55d_1/IRR-DiffSR/results/test_DiffIRGANS2_UFO120_x2/visualization/UDiffSR_UFO120_x2')
    args = parser.parse_args()
    psnr_all = []
    ssim_all = []
    img_list = sorted(glob.glob(osp.join(args.folder_gt, '*.jpg')))
